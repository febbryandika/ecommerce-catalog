 ...
 *
 * An empty wishlist is the correct answer for a signed-out visitor, not a 401: the UI already shows
...
export async function GET() {
  ...
  // Private and uncacheable: this is one user's wishlist, and it sits behind a shared CDN.
